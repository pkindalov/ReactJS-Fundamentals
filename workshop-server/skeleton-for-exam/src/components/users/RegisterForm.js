...
const RegisterForm = (props) => (
  <form>
    <div>{props.error}</div>
    <Input name='email' type='email' placeholder='Email:' value={props.user.email} onChange={props.onChange} />
    ...
    <br />
    <Input type='text' name='name' placeholder='Name:' value={props.user.name} onChange={props.onChange} />
